...
Executes exactly the design in ``STUDY3_EXPLORATORY_E1_DESIGN_V1.json``: sixty
...
def execute(task):
    ...
    packet = {"schema": "study3_exploratory_e1_packet_v1",
...
def main():
    ...
    summary = {"schema": "study3_exploratory_e1_summary_v1",
