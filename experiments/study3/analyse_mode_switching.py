...
E1_PACKETS = HERE / "redesign_results/exploratory_e1"
...
def run_e1():
    ...
    for path in sorted(E1_PACKETS.glob("*.json")):
        ...
        out.append({"source": "E1", "case": str(identity["environment_seed"]),
...
def main():
    ...
    path = HERE / "redesign_results/mode_switching_analysis.json"
